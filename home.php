       ...
       <h1><a href="index.php"><span><img src="assets/img/logo.png"></span></a></h1>
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="#details">عن الموقع</a></li>
            ...
            <ul class="user">
             <!-- <li class="dropdown"><a href="#"><i class="iconify" data-icon="bi:person-circle"></i><span>سميره عويس</span></a> -->
              <li class="dropdown"><a href="#"><i class="iconify" data-icon="bi:person-circle"></i></a>
                <ul>
